...
const projects = [
  {
    ...
    title: 'Sniper Game',
    description:
      'Jeu de tir développé en Python avec Pygame. Mécaniques de jeu complètes incluant la physique des balles, des niveaux progressifs de difficulté et un système de score.',
    tags: ['Python', 'Pygame'],
  ...
  },
  {
    ...
    description:
      "Système de réservation d'espaces avec interface web complète et client administrateur Java. Architecture full-stack avec base de données relationnelle.",
  ...
  },
  {
    ...
    title: 'Discord Bot',
    description:
      "Bot Discord polyvalent développé avec Node.js et Discord.js. Fonctionnalités de modération automatique, commandes personnalisées et intégrations diverses.",
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-1.5 mb-6">
          {project.tags.map((t) => (
            <span
              key={t}
              className="px-2.5 py-0.5 text-xs rounded-md bg-zinc-800/80 text-zinc-400 border border-zinc-700/50"
            >
              {t}
            </span>
          ))}
